Swal.fire({
    ...
    text:'¿Que te regale por delivery la primera vez?',
    // html:
    icon:'question',
...
function pregunta_1(){
if (pregunta1.value === "chocolates y lasaña" || pregunta1.value === "Ferrero Rocher y Lasagna" || pregunta1.value === "Ferrero Rocher y Lasaña" || pregunta1.value === "Chocolates y Lasagna"){
    Swal.fire({
